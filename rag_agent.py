...
# For reload it: chroma_db = Chroma(persist_directory="./chroma_db", embedding_function=embeddings)
...
graph.add_node("retrieve", retrieve_context) # Node 1.5
